...
export default function Reservation_search(props) {
    ...
    function filter_res(inputvalue) {
        ...
        var filter_temp = reservation.filter((this_reservation) => {
            ...
            return (
                res_cus_name.toLowerCase().includes(inputvalue.toLowerCase()) ||
            ...
            <Grid container direction="row" justify="space-between" alignItems="center" spacing={3}>
                <Grid item>
                    <input
                        ...
                        id="search"
                        placeholder="搜尋"
                        onChange={(e) => filter_res(e.target.value)}
                        style={{ color: 'black' }}
                    />
                </Grid>
                <Grid item>
                    <Grid container direction="row" justify="flex-end" alignItems="center" spacing={3}>
                        <Grid item>
                            {SelectedId_arr.length === 1 && (
                                <ReservationUpdate update_id={SelectedId_arr[0]} reservation={SelectedReservation} />
                            )}
                        </Grid>
                        <Grid item>
                        ...
                        <Table tablename="reservation">
                            ...
                            <TableBody>
                                {(rowsPerPage > 0
                                    ...
                                    : filteredReservation
                                ).map((this_reservation) => (
                                    <TableRow key={this_reservation.fields.res_id}>
                                        <TableCell padding="checkbox">
                                            <Checkbox
                                                id={this_reservation.fields.res_id.toString()}
                                        ...
                                        <TableCell>
                                            {moment(this_reservation.fields.res_date).format('YYYY-MM-DD HH:mm')}
                                        </TableCell>
