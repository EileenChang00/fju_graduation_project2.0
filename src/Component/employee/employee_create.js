        ...
        <div>
            ...
            <Dialog open={open} onClose={handleClose}>
                ...
                <DialogContent>
                    ...
                    <TextField margin="dense" label="帳號" type="text" value={newAccount} onChange={ChangeAccount} fullWidth />
                    <TextField margin="dense" label="密碼" type="text" value={newPassword} onChange={ChangePassword} fullWidth />
                    <TextField margin="dense" label="手機" type="number" value={newPhone} onChange={(event) => phoneFormat(event.target.value)} fullWidth error={phoneError} helperText={phoneError && "輸入長度有誤"}/>
                    <InputLabel>生日</InputLabel>
                    <TextField margin="dense" type="date" value={newBirth} onChange={ChangeBirth} fullWidth />
                    <TextField margin="dense" label="身分證字號" type="text" value={newIDnumber} onChange={(event) => IDFormat(event.target.value)} fullWidth error={IDError} helperText={IDError && "輸入長度有誤"}/>
