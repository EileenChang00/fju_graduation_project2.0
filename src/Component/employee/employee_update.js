        ...
        <div>
            ...
            <Dialog open={open} onClose={handleClose}>
                ...
                <DialogContent>
                    ...
                    <TextField margin="dense" label="手機" type="text" value={newPhone} onChange={ChangePhone} fullWidth error={phoneError} helperText={phoneError && "輸入長度有誤"}/>
                    <InputLabel>生日</InputLabel>
                    <TextField margin="dense" type="date" value={newBirth} onChange={ChangeBirth} fullWidth />
                    <TextField margin="dense" label="身分證字號" type="text" value={newIDnumber} onChange={ChangeIDnumber} fullWidth error={IDError} helperText={IDError && "輸入長度有誤"}/>
