...
export default function Buy_search(props) {
    ...
    function filter_buy(inputvalue) {
        ...
        var filter_temp = buy.filter((this_buy) => {
            ...
            return (
                buy_cus_name.toLowerCase().includes(inputvalue.toLowerCase()) ||
            ...
            <Grid container direction="row" justify="space-between" alignItems="center" spacing={3}>
                <Grid item>
                    <input
                        ...
                        id="search"
                        placeholder="搜尋"
                        onChange={(e) => filter_buy(e.target.value)}
                        style={{ color: 'black' }}
                    />
                </Grid>
                <Grid item>
                    <Grid container direction="row" justify="flex-end" alignItems="center" spacing={3}>
                        <Grid item>
                            {SelectedId_arr.length === 1 && (
                                <BuyUpdate update_id={SelectedId_arr[0]} buy={SelectedBuy} />
                            )}
                        </Grid>
                        <Grid item>{SelectedId_arr.length > 0 && <BuyDelete delete_id={SelectedId_arr} />}</Grid>
                        <Grid item>
                            <BuyCreate />
                        </Grid>
                    </Grid>
