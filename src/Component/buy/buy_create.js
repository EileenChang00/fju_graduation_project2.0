...
import { Button, Dialog, DialogContent, DialogTitle, DialogActions, TextField, InputLabel, Select, MenuItem, Grid, IconButton, Typography, FormControl } from "@material-ui/core";
...
export default function Buy_create(){
    ...
    const ChangesaleCount = (event) =>{
        ...
        //點擊 Sale 的 Add Icon
    const addSale = () =>{
        value_sale.includes(saleName) ? value_sale.push([saleName,saleCount]) : value_sale.push([saleName,saleCount,saleId,saleCategory,salePrice]);
