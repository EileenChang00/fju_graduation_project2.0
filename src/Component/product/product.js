...
export default function Product_search(props){
    ...
    function filter_product(inputvalue){
        ...
        var filter_temp = product.filter((this_product) => {
            ...
            return this_product.fields.product_name.toLowerCase().includes(inputvalue.toLowerCase())
    ...
    return(
        <div>
          <Grid container direction="row" justify="space-between" alignItems="center" spacing={3}>
            <Grid item>
              <input type="text" id="search" placeholder="搜尋" onChange={e => filter_product(e.target.value)} style={{ color: "black" }} />
            </Grid>
            <Grid item>
                    ...
                    <Table tablename='product'>
                        ...
                        <TableBody>
                            {(rowsPerPage > 0
                                ...
                                : filteredProduct).map((this_product)=>(
                                <TableRow key={this_product.fields.product_id}>
                                    <TableCell padding="checkbox">
                                        <Checkbox id={this_product.fields.product_id.toString()} onClick={handleSelect}/>
                                    </TableCell>
