...
export default function Come_search(props) {
    ...
    function filter_com(inputvalue){
        ...
        var filter_temp = come.filter((this_come) => {
            ...
            return com_cus_name.toLowerCase().includes(inputvalue.toLowerCase())
    ...
    return(
        <div>
          <Grid container direction="row" justify="space-between" alignItems="center" spacing={3}>
            <Grid item>
              <input type="text" id="search" placeholder="搜尋" onChange={e => filter_com(e.target.value)} style={{ color: "black" }} />
            </Grid>
            <Grid item>
