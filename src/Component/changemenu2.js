...
function Changemenu2() {
    ...
    return (
        <div class="container-fluid">
            <h1 class="mt-4" style={{ color: 'black' }}>選單修改</h1>
            <div class='bar'>
                <h5><Link to="/home/changemenu">職業選單/<br />得知管道選單/<br />售後服務選單</Link></h5>
                <h5><Link to="/home/changemenu2">產品類別選單/<br />產品系列選單/<br />產品尺寸選單</Link></h5>
                <h5><Link to="/home/changemenu3">廠商類別選單/<br />拜訪方式選單/<br />拜訪目的選單</Link></h5>
            </div>
            <div class='block1'>
                <p>產品類別選單</p>
                <div align='center'>新增類別:&nbsp;<input name='newproduct' onChange={onChangeproduct}></input>&nbsp;&nbsp;<button type="button" class="badge rounded-pill bg-success" style={{ width: "80px", height: "40px" }} onClick={createproduct}>新增</button>
                    <button type="button" class="badge rounded-pill bg-danger" style={{ width: "80px", height: "40px" }} id="delete" onClick={deleteproduct}>刪除</button>
                </div>
                <div class="list1">
                    {productsplit1.map(productsplit1 =>
                        <li><input type="radio" name="product" id={productsplit1[0]} />&nbsp;&nbsp;{productsplit1[1]}</li>
                    )}
                </div>
                <div class='list2'>
                    {productsplit2.map(productsplit2 =>
                        <li><input type="radio" name="product" id={productsplit2[0]} />&nbsp;&nbsp;{productsplit2[1]}</li>
                    )}
                </div>
                <div class='list3'>
                    {productsplit3.map(productsplit3 =>
                        <li><input type="radio" name="product" id={productsplit3[0]} />&nbsp;&nbsp;{productsplit3[1]}</li>
                    )}
                </div>
            </div>
            <div class='block2'>
                <p>產品系列選單</p>
                <div align='center'>新增系列:&nbsp;<input name='newseries' onChange={onChangeseries}></input>&nbsp;&nbsp;<button type="button" class="badge rounded-pill bg-success" style={{ width: "80px", height: "40px" }} onClick={createseries}>新增</button>
                    <button type="button" class="badge rounded-pill bg-danger" style={{ width: "80px", height: "40px" }} id="delete" onClick={deleteseries}>刪除</button>
                </div>
                <div class="list1">
                    {seriessplit1.map(seriessplit1 =>
                        <li><input type="radio" name="series" id={seriessplit1[0]} />&nbsp;&nbsp;{seriessplit1[1]}</li>
                    )}
                </div>
                <div class='list2'>
                    {seriessplit2.map(seriessplit2 =>
                        <li><input type="radio" name="series" id={seriessplit2[0]} />&nbsp;&nbsp;{seriessplit2[1]}</li>
                    )}
                </div>
                <div class='list3'>
                    {seriessplit3.map(seriessplit3 =>
                        <li><input type="radio" name="series" id={seriessplit3[0]} />&nbsp;&nbsp;{seriessplit3[1]}</li>
                    )}
                </div>
            </div>
            <div class='block3'>
                <p>產品尺寸選單</p>
                <div align='center'>新增尺寸:&nbsp;<input name='newsize' onChange={onChangesize}></input>&nbsp;&nbsp;<button type="button" class="badge rounded-pill bg-success" style={{ width: "80px", height: "40px" }} onClick={createsize}>新增</button>
                    <button type="button" class="badge rounded-pill bg-danger" style={{ width: "80px", height: "40px" }} id="delete" onClick={deletesize}>刪除</button>
                </div>
                <div class="list1">
                    {sizesplit1.map(sizesplit1 =>
                        <li><input type="radio" name="size" id={sizesplit1[0]} />&nbsp;&nbsp;{sizesplit1[1]}</li>
                    )}
                </div>
                <div class='list2'>
                    {sizesplit2.map(sizesplit2 =>
                        <li><input type="radio" name="size" id={sizesplit2[0]} />&nbsp;&nbsp;{sizesplit2[1]}</li>
                    )}
                </div>
                <div class='list3'>
                    {sizesplit3.map(sizesplit3 =>
                        <li><input type="radio" name="size" id={sizesplit3[0]} />&nbsp;&nbsp;{sizesplit3[1]}</li>
                    )}
                </div>
            </div>
        </div>
