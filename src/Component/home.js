            ...
            <Grid item>
                <Grid container direction="row" justify="flex-end" alignItems="center" spacing={4}>
                    ...
                    <Grid item>
                        ...
                        >
                            <MenuItem onClick={handleCloseMenu} component={Link} to="/home/Changepw">修改密碼</MenuItem>
                            <MenuItem onClick={handleCloseMenu} component={Link} to="/home/changemenu">選單修改</MenuItem>
                            <Divider />
        ...
        >
            ...
            <List>
                ...
                <Collapse in={openBa} timeout="auto" unmountOnExit>
                    ...
                    {localStorage.getItem('level') === 'B' && <ListItem component={Link} to="/home/employee" color="default" className={classes.nested}>
                        <ListItemIcon>
                        <StorageRoundedIcon />
                        </ListItemIcon>
                        <font style={{ color: "black" }}><ListItemText primary="員工" /></font>
                    </ListItem>}
                    <ListItem component={Link} to="/home/customer" color="inherit" className={classes.nested}>
                        <ListItemIcon>
                        <StorageRoundedIcon />
                        </ListItemIcon>
                        <font style={{ color: "black" }}><ListItemText primary="顧客" /></font>
                    </ListItem>
                    <ListItem component={Link} to="/home/product" color="inherit" className={classes.nested}>
                        <ListItemIcon>
                        <StorageRoundedIcon />
                        </ListItemIcon>
                        <font style={{ color: "black" }}><ListItemText primary="產品" /></font>
                    </ListItem>
                    <ListItem component={Link} to="/home/producer" color="inherit" className={classes.nested}>
                        <ListItemIcon>
                        <StorageRoundedIcon />
                        </ListItemIcon>
                        <font style={{ color: "black" }}><ListItemText primary="後勤廠商" /></font>
                    </ListItem>
                    <ListItem component={Link} to="/home/firm" color="inherit" className={classes.nested}>
                        <ListItemIcon>
                        <StorageRoundedIcon />
                        </ListItemIcon>
                        <font style={{ color: "black" }}><ListItemText primary="廠商" /></font>
                    </ListItem>
                    <ListItem component={Link} to="/home/firmstaff" color="inherit" className={classes.nested}>
                        <ListItemIcon>
                        <StorageRoundedIcon />
                        </ListItemIcon>
                        <font style={{ color: "black" }}><ListItemText primary="廠商員工" /></font>
                    </ListItem>
                    </List>
                </Collapse>
            </List>
            ...
            <List>
                ...
                <Collapse in={openEx} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                    <ListItem component={Link} to="/home/reservation" color="inherit" className={classes.nested}>
                        <ListItemIcon>
                        <StorageRoundedIcon />
                        </ListItemIcon>
                        <font style={{ color: "black" }}><ListItemText primary="預約" /></font>
                    </ListItem>
                    <ListItem component={Link} to="/home/come" color="inherit" className={classes.nested}>
                        <ListItemIcon>
                        <StorageRoundedIcon />
                        </ListItemIcon>
                        <font style={{ color: "black" }}><ListItemText primary="來訪" /></font>
                    </ListItem>
                    <ListItem component={Link} to="/home/buy" color="inherit" className={classes.nested}>
                        <ListItemIcon>
                        <StorageRoundedIcon />
                        </ListItemIcon>
                        <font style={{ color: "black" }}><ListItemText primary="購買" /></font>
                    </ListItem>
                    <ListItem component={Link} to="/home/service" color="inherit" className={classes.nested}>
                        <ListItemIcon>
                        <StorageRoundedIcon />
                        </ListItemIcon>
                        <font style={{ color: "black" }}><ListItemText primary="售後服務" /></font>
                    </ListItem>
                    <ListItem component={Link} to="/home/visit" color="inherit" className={classes.nested}>
                        <ListItemIcon>
                        <StorageRoundedIcon />
                        </ListItemIcon>
                        <font style={{ color: "black" }}><ListItemText primary="拜訪" /></font>
                    </ListItem>
                    </List>
                </Collapse>
            </List>
            ...
            <List>
                ...
                <Collapse in={openCh} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                    <ListItem component={Link} to="/home/Chart" color="inherit" className={classes.nested}>
                        <ListItemIcon>
                        <StorageRoundedIcon />
                        </ListItemIcon>
                        <font style={{ color: "black" }}><ListItemText primary="營業報表" /></font>
                    </ListItem>
                    <ListItem component={Link} to="/home/YearOnYear" color="inherit" className={classes.nested}>
                        <ListItemIcon>
                        <StorageRoundedIcon />
                        </ListItemIcon>
                        <font style={{ color: "black" }}><ListItemText primary="同比報表" /></font>
                    </ListItem>
                    <ListItem component={Link} to="/home/Intro" color="inherit" className={classes.nested}>
                        <ListItemIcon>
                        <StorageRoundedIcon />
                        </ListItemIcon>
                        <font style={{ color: "black" }}><ListItemText primary="介紹次數" /></font>
                    </ListItem>
                    <ListItem component={Link} to="/home/Chart_em" color="inherit" className={classes.nested}>
                        <ListItemIcon>
                        <StorageRoundedIcon />
                        </ListItemIcon>
                        <font style={{ color: "black" }}><ListItemText primary="員工業績" /></font>
                    </ListItem>
                    <ListItem component={Link} to="/home/Important_Cus" color="inherit" className={classes.nested}>
                        <ListItemIcon>
                        <StorageRoundedIcon />
                        </ListItemIcon>
                        <font style={{ color: "black" }}><ListItemText primary="重要顧客" /></font>
                    </ListItem>
                    <ListItem component={Link} to="/home/Name" color="inherit" className={classes.nested}>
                        <ListItemIcon>
                        <StorageRoundedIcon />
                        </ListItemIcon>
                        <font style={{ color: "black" }}><ListItemText primary="產品分析" /></font>
                    </ListItem>
                    </List>
                </Collapse>
            </List>
