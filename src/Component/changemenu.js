...
function Changemenu() {
    ...
    return (
                    <div class="container-fluid">
                        ...
                        <div class='block1'>
                            <p>職業選單</p>
                            <div align='center'>新增職業:&nbsp;<input name='newpro' onChange={onChangepro}></input>&nbsp;&nbsp;<button type="button" class="badge rounded-pill bg-success" style={{ width: "80px", height: "40px", color: "white" }} onClick={createpro}>新增</button>
                                <button type="button" class="badge rounded-pill bg-danger" style={{ width: "80px", height: "40px"}} id="delete" onClick={deletepro}>刪除</button>
                            </div>
                            <div class="list1">
                                {prosplit1.map(prosplit1 =>
                                    <li><input type="radio" name="pro" id={prosplit1[0]} />&nbsp;&nbsp;{prosplit1[1]}</li>
                                )}
                            </div>
                            <div class='list2'>
                                {prosplit2.map(prosplit2 =>
                                    <li><input type="radio" name="pro" id={prosplit2[0]} />&nbsp;&nbsp;{prosplit2[1]}</li>
                                )}
                            </div>
                            <div class='list3'>
                                {prosplit3.map(prosplit3 =>
                                    <li><input type="radio" name="pro" id={prosplit3[0]} />&nbsp;&nbsp;{prosplit3[1]}</li>
                                )}
                            </div>
                        </div>
                        <div class='block2'>
                            <p>得知管道選單</p>
                            <div align='center' >新增管道:&nbsp;<input name='newinfo' onChange={onChangeinfo}></input>&nbsp;&nbsp;<button type="button" class="badge rounded-pill bg-success" style={{ width: "80px", height: "40px" }} onClick={createinfo}>新增</button>
                                <button type="button" class="badge rounded-pill bg-danger" style={{ width: "80px", height: "40px"}} id="delete" onClick={deleteinfo}>刪除</button>
                            </div>
                            <div class="list1">
                                {infosplit1.map(infosplit1 =>
                                    <li ><input type="radio" name="info" id={infosplit1[0]} />&nbsp;&nbsp;{infosplit1[1]}</li>
                                )}
                            </div>
                            <div class='list2'>
                                {infosplit2.map(infosplit2 =>
                                    <li><input type="radio" name="info" id={infosplit2[0]} />&nbsp;&nbsp;{infosplit2[1]}</li>
                                )}
                            </div>
                            <div class='list3'>
                                {infosplit3.map(infosplit3 =>
                                    <li><input type="radio" name="info" id={infosplit3[0]} />&nbsp;&nbsp;{infosplit3[1]}</li>
                                )}
                            </div>
                        </div>
                        <div class='block3'>
                            <p>售後服務選單</p>
                            <div align='center'>新增服務:&nbsp;<input name='newser' onChange={onChangeser}></input>&nbsp;&nbsp;<button type="button" class="badge rounded-pill bg-success" style={{ width: "80px", height: "40px"}} onClick={createser}>新增</button>
                                <button type="button" class="badge rounded-pill bg-danger" style={{ width: "80px", height: "40px"}} id="delete" onClick={deleteser}>刪除</button>
                            </div>
                            <div class="list1">
                                {sersplit1.map(sersplit1 =>
                                    <li><input type="radio" name="ser" id={sersplit1[0]} />&nbsp;&nbsp;{sersplit1[1]}</li>
                                )}
                            </div>
                            <div class='list2'>
                                {sersplit2.map(sersplit2 =>
                                    <li><input type="radio" name="ser" id={sersplit2[0]} />&nbsp;&nbsp;{sersplit2[1]}</li>
                                )}
                            </div>
                            <div class='list3'>
                                {sersplit3.map(sersplit3 =>
                                    <li><input type="radio" name="ser" id={sersplit3[0]} />&nbsp;&nbsp;{sersplit3[1]}</li>
                                )}
                            </div>
                        </div>
                    </div>
