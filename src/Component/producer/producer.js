...
export default function Producer_search(props) {
    ...
    function filter_producer(inputvalue) {
        ...
        var filter_temp = producer.filter((this_producer) => {
            ...
            return (
                this_producer.fields.producer_name.toLowerCase().includes(inputvalue.toLowerCase()) ||
            ...
            <Grid container direction="row" justify="space-between" alignItems="center" spacing={3}>
                <Grid item>
                    <input
                        ...
                        id="search"
                        placeholder="搜尋"
                        onChange={(e) => filter_producer(e.target.value)}
                        style={{ color: 'black' }}
                    />
                </Grid>
                <Grid item>
                    <Grid container direction="row" justify="flex-end" alignItems="center" spacing={3}>
                        <Grid item>
                            {SelectedId_arr.length === 1 && (
                                <ProducerUpdate update_id={SelectedId_arr[0]} producer={SelectedProducer} />
                            )}
                        </Grid>
                        <Grid item>{SelectedId_arr.length > 0 && <ProducerDelete delete_id={SelectedId_arr} />}</Grid>
                        <Grid item>
                            <ProducerCreate />
                        </Grid>
                    </Grid>
                                ...
                                {(rowsPerPage > 0
                                    ...
                                    <TableRow key={this_producer.fields.producer_id}>
                                        <TableCell padding="checkbox">
                                            <Checkbox
                                                id={this_producer.fields.producer_id.toString()}
