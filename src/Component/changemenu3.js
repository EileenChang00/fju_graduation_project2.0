...
function Changemenu3() {
    ...
    return (
        <div class="container-fluid">
            ...
            <div class='block1'>
                <p>廠商類別選單</p>
                <div align='center'>新增類別:&nbsp;<input name='newfirm' onChange={onChangefirm}></input>&nbsp;&nbsp;<button type="button" class="badge rounded-pill bg-success" style={{ width: "80px", height: "40px" }} onClick={createfirm}>新增</button>
                    <button type="button" class="badge rounded-pill bg-danger" style={{ width: "80px", height: "40px" }} id="delete" onClick={deletefirm}>刪除</button>
                </div>
                <div class="list1">
                    {firmsplit1.map(firmsplit1 =>
                        <li><input type="radio" name="firm" id={firmsplit1[0]} />&nbsp;&nbsp;{firmsplit1[1]}</li>
                    )}
                </div>
                <div class='list2'>
                    {firmsplit2.map(firmsplit2 =>
                        <li><input type="radio" name="firm" id={firmsplit2[0]} />&nbsp;&nbsp;{firmsplit2[1]}</li>
                    )}
                </div>
                <div class='list3'>
                    {firmsplit3.map(firmsplit3 =>
                        <li><input type="radio" name="firm" id={firmsplit3[0]} />&nbsp;&nbsp;{firmsplit3[1]}</li>
                    )}
                </div>
            </div>
            <div class='block2'>
                <p>拜訪方式選單</p>
                <div align='center'>新增方式:&nbsp;<input name='newvisit' onChange={onChangevisit}></input>&nbsp;&nbsp;<button type="button" class="badge rounded-pill bg-success" style={{ width: "80px", height: "40px" }} onClick={createvisit}>新增</button>
                    <button type="button" class="badge rounded-pill bg-danger" style={{ width: "80px", height: "40px" }} id="delete" onClick={deletevisit}>刪除</button>
                </div>
                <div class="list1">
                    {visitsplit1.map(visitsplit1 =>
                        <li><input type="radio" name="visit" id={visitsplit1[0]} />&nbsp;&nbsp;{visitsplit1[1]}</li>
                    )}
                </div>
                <div class='list2'>
                    {visitsplit2.map(visitsplit2 =>
                        <li><input type="radio" name="visit" id={visitsplit2[0]} />&nbsp;&nbsp;{visitsplit2[1]}</li>
                    )}
                </div>
                <div class='list3'>
                    {visitsplit3.map(visitsplit3 =>
                        <li><input type="radio" name="visit" id={visitsplit3[0]} />&nbsp;&nbsp;{visitsplit3[1]}</li>
                    )}
                </div>
            </div>
            <div class='block3'>
                <p>拜訪目的選單</p>
                <div align='center'>新增目的:&nbsp;<input name='newpurpose' onChange={onChangepurpose}></input>&nbsp;&nbsp;<button type="button" class="badge rounded-pill bg-success" style={{ width: "80px", height: "40px" }} onClick={createpurpose}>新增</button>
                    <button type="button" class="badge rounded-pill bg-danger" style={{ width: "80px", height: "40px" }} id="delete" onClick={deletepurpose}>刪除</button>
                </div>
                <div class="list1">
                    {purposesplit1.map(purposesplit1 =>
                        <li><input type="radio" name="purpose" id={purposesplit1[0]} />&nbsp;&nbsp;{purposesplit1[1]}</li>
                    )}
                </div>
                <div class='list2'>
                    {purposesplit2.map(purposesplit2 =>
                        <li><input type="radio" name="purpose" id={purposesplit2[0]} />&nbsp;&nbsp;{purposesplit2[1]}</li>
                    )}
                </div>
                <div class='list3'>
                    {purposesplit3.map(purposesplit3 =>
                        <li><input type="radio" name="purpose" id={purposesplit3[0]} />&nbsp;&nbsp;{purposesplit3[1]}</li>
                    )}
                </div>
            </div>
        </div>
