...
export default function Bulletin(){
    ...
    return(
        ...
        <div class="container-fluid">
            <h1 class="mt-4"><font style={{ color: 'black' }}>公告</font></h1>
            ...
            <table border="1" cellpadding="5" align="center" style={{fontSize:'large'}}>
                ...
                {reservation.map((reservation)=>(
                    <tr>
                        ...
                        <td><input type="checkbox" name="resStatus[]" value={reservation.id} id="resStatus" onClick={resStatusDone}></input></td>
                    </tr>
                ))}
            </table>
            <p></p>
            ...
            <table border="1" cellpadding="5" align="center" style={{fontSize:'large'}}>
                ...
                {service.map((service)=>(
                    <tr>
                        ...
                        <td><a href={"mailto:" + service.fields.ser_cus_email}>{service.fields.ser_project}</a></td>
                        <td>{service.fields.ser_status}</td>
                        <td><input type="checkbox" name="serStatus[]" value={service.id} id="serStatus" onClick={serStatusDone}></input></td>
                    </tr>
                ))}
            </table>
        </div>
