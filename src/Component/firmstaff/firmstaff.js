...
export default function Firmstaff_search(props){
    ...
    function filter_firmstaff(inputvalue){
        ...
        var filter_temp = firmstaff.filter((this_firmstaff) => {
            ...
            return this_firmstaff.fields.firmstaff_name.toLowerCase().includes(inputvalue.toLowerCase())
    ...
    return(
        <div>
          <Grid container direction="row" justify="space-between" alignItems="center" spacing={3}>
            <Grid item>
              <input type="text" id="search" placeholder="搜尋" onChange={e => filter_firmstaff(e.target.value)} style={{ color: "black" }} />
            </Grid>
            <Grid item>
              <Grid container direction="row" justify="flex-end" alignItems="center" spacing={3}>
                ...
                <Grid item><FirmstaffCreate /></Grid>
              </Grid>
            </Grid>
          </Grid>
                    ...
                    <Table tablename="firmstaff">
                        ...
                        <TableBody>
                            {(rowsPerPage > 0
                                ...
                                : filteredFirmstaff).map((this_firmstaff)=>(
                                <TableRow key={this_firmstaff.fields.firmstaff_id}>
                                    <TableCell padding="checkbox">
                                        <Checkbox id={this_firmstaff.fields.firmstaff_id.toString()} onClick={handleSelect}/>
                                    </TableCell>
