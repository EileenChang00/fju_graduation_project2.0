import { Grid, Table, TableCell, TableRow, TableContainer, TableHead, Checkbox, TableBody, TablePagination, Paper, Button, Icon } from "@material-ui/core";
...
export default function Customer_search(props) {
    ...
    const handleSelect = (event) => {
        ...
        base('customer').select({
            ...
            records.forEach(function (record) {
                ...
                new_arr2.includes(record.fields.cus_email) ? new_arr2 = new_arr2.filter(item => item !== record.fields.cus_email) : new_arr2 = [...new_arr2, record.fields.cus_email];
                setUpdateId(new_arr);
    ...
    function filter_cus(inputvalue) {
        ...
        var filter_temp = customer.filter((this_customer) => {
            ...
            return this_customer.fields.cus_name.toLowerCase().includes(inputvalue.toLowerCase())
          ...
          <Grid container direction="row" justify="space-between" alignItems="center" spacing={3}>
            <Grid item>
              <Grid container direction="row" justify="flex=start" alignItems="center" spacing={3}>
                <Grid item>
                  <input type="text" id="search" placeholder="搜尋" onChange={e => filter_cus(e.target.value)} style={{ color: "black" }} />
                </Grid>
                <Grid item>
                  <Button
                    variant="contained"
                    ...
                    spacing={3}
                    endIcon={<SendIcon />}
                  ><a href={"mailto:" + emaillist} style={{ color: 'white' }}>E-mail</a>
                  </Button>
                </Grid>
              </Grid>
            </Grid>
                    ...
                    <Table tablename='customer' className={classes.table}>
                        ...
                        <TableBody>
                            {(rowsPerPage > 0
                                ...
                                : filteredCustomer).map((this_customer)=>(
                                    <TableRow key={this_customer.fields.cus_id}>
                                        <TableCell padding="checkbox">
                                            <Checkbox id={this_customer.fields.cus_id.toString()} onClick={handleSelect} />
                                        </TableCell>
