...
export default function Visit_search(props){
    ...
    function filter_vis(inputvalue){
        ...
        var filter_temp = visit.filter((this_visit) => {
            ...
            return vis_firmstaff_name.toLowerCase().includes(inputvalue.toLowerCase())
    ...
    return(
        <div>
          <Grid container direction="row" justify="space-between" alignItems="center" spacing={3}>
            <Grid item>
              <input type="text" id="search" placeholder="搜尋" onChange={e => filter_vis(e.target.value)} style={{ color: "black" }} />
            </Grid>
            <Grid item>
              <Grid container direction="row" justify="flex-end" alignItems="center" spacing={3}>
                <Grid item>
                    {SelectedId_arr.length === 1 && <VisitUpdate update_id={SelectedId_arr[0]} visit={SelectedVisit} />}
                </Grid>
                <Grid item>
                    {SelectedId_arr.length > 0 && <VisitDelete delete_id={SelectedId_arr} />}
                </Grid>
                <Grid item><VisitCreate /></Grid>
              </Grid>
            </Grid>
          </Grid>
