...
export default function Firm_search(props) {
    ...
    function filter_firm(inputvalue) {
        ...
        var filter_temp = firm.filter((this_firm) => {
            ...
            return (
                this_firm.fields.firm_name.toLowerCase().includes(inputvalue.toLowerCase()) ||
            ...
            <Grid container direction="row" justify="space-between" alignItems="center" spacing={3}>
                <Grid item>
                    <input
                        ...
                        id="search"
                        placeholder="搜尋"
                        onChange={(e) => filter_firm(e.target.value)}
                        style={{ color: 'black' }}
                    />
                </Grid>
                <Grid item>
                    <Grid container direction="row" justify="flex-end" alignItems="center" spacing={3}>
                        <Grid item>
                            {SelectedId_arr.length === 1 && (
                                <FirmUpdate update_id={SelectedId_arr[0]} firm={SelectedFirm} />
                            )}
                        </Grid>
                        <Grid item>{SelectedId_arr.length > 0 && <FirmDelete delete_id={SelectedId_arr} />}</Grid>
                        <Grid item>
                            <FirmCreate />
                        </Grid>
                    </Grid>
